...
// async function json_parse(id) { // not intended for direct calls, this fetches the object and calls the json_fill with the object 
//   result = await $.getJSON(
//     "http://localhost/Quaerere/Quaerere_server/?guid=" + id
//   );
